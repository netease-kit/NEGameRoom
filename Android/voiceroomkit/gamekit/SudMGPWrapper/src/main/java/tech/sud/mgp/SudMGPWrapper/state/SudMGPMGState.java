...
/** MG to APP 的状态定义 参考文档：https://docs.sud.tech/zh-CN/app/Client/MGFSM/ */
public class SudMGPMGState implements Serializable {
  ...
  /** 1. 公屏消息（已修改） 最低版本: v1.1.30.xx */
  public static final String MG_COMMON_PUBLIC_MESSAGE = "mg_common_public_message";

  /**
   * 1. 公屏消息（已修改） 向公屏发送消息，字段含义如下 type 0 通知 1 提醒 2 结算 3 其他 msg
   * <!-- -->
   * 内为转义字段：
  ...
  /** 4. 加入游戏按钮点击状态 模型 用户（本人）点击加入按钮，或者点击头像加入 */
  ...
  /** 5. 取消加入(退出)游戏按钮点击状态 */
  public static final String MG_COMMON_SELF_CLICK_CANCEL_JOIN_BTN =
      "mg_common_self_click_cancel_join_btn";

  /** 5. 取消加入(退出)游戏按钮点击状态 模型 用户（本人）点击取消加入按钮 */
  ...
  /** 7. 取消准备按钮点击状态 */
  public static final String MG_COMMON_SELF_CLICK_CANCEL_READY_BTN =
  ...
  public static final String MG_COMMON_SELF_CLICK_GAME_SETTLE_CLOSE_BTN =
      "mg_common_self_click_game_settle_close_btn";

  /** 11. 结算界面关闭按钮点击状态（2021-12-27新增） 模型 用户（本人）点击结算界面关闭按钮 */
  public static class MGCommonSelfClickGameSettleCloseBtn implements Serializable {}

  /** 12. 结算界面再来一局按钮点击状态（2021-12-27新增） */
  public static final String MG_COMMON_SELF_CLICK_GAME_SETTLE_AGAIN_BTN =
      "mg_common_self_click_game_settle_again_btn";

  /** 12. 结算界面再来一局按钮点击状态（2021-12-27新增）模型 用户（本人）点击结算界面再来一局按钮 */
  ...
  /** 13. 游戏上报游戏中的声音列表（2021-12-30新增，现在只支持碰碰我最强） 模型 游戏上报本游戏中所有的声音资源列表 */
  ...
  /** 14. 游通知app层播放声音（2021-12-30新增，现在只支持碰碰我最强） 模型 游戏通知app层播放背景音乐的开关状态 */
  public static class MGCommonGameSound implements Serializable {
  ...
  /** 15. 游戏通知app层播放背景音乐状态（2022-01-07新增，现在只支持碰碰我最强） 模型 游戏通知app层播放背景音乐的开关状态 */
  ...
  /** 16. 游戏通知app层播放音效的状态（2022-01-07新增，现在只支持碰碰我最强） 模型 游戏通知app层播放音效的状态 */
  ...
  /** 18. 麦克风状态（2022-02-08新增） 模型 游戏通知app麦克风状态 */
  ...
  public static class MGCommonAPPCommonSelfXResp implements Serializable {
    public String
        state; // 字段必填, 参考：游戏业务错误 https://docs.sud.tech/zh-CN/app/Client/APPFST/CommonState.html
  ...
  /** 1.加入状态（已修改） 最低版本: v1.1.30.xx */
  public static final String MG_COMMON_PLAYER_IN = "mg_common_player_in";

  /** 1.加入状态（已修改） 模型 用户是否加入游戏； 游戏开始后，未加入的用户为OB视角。 */
  ...
  /** 7. 游戏通知app点击玩家头像 */
  public static final String MG_COMMON_SELF_CLICK_GAME_PLAYER_ICON =
  ...
  /** 3. 显示错误答案状态（已修改） 模型 错误的答案，最多6中文，头像正下方 */
  ...
  /** 1. 元宇宙砂砂舞指令回调 模型 app指令请求游戏客户端成功与否的回调 */
  ...
  /** 2. 元宇宙砂砂舞指令动作结束通知 模型 游戏客户端通知APP指令动作结束 */
  ...
  /** 5. 订单记录列表(火箭) */
  public static final String MG_CUSTOM_ROCKET_ORDER_RECORD_LIST =
  ...
  /** 6. 展馆内列表(火箭) */
  public static final String MG_CUSTOM_ROCKET_ROOM_RECORD_LIST =
  ...
  /** 7. 展馆内玩家送出记录(火箭) */
  public static final String MG_CUSTOM_ROCKET_USER_RECORD_LIST =
  ...
  /** 8. 设置默认模型(火箭) */
  public static final String MG_CUSTOM_ROCKET_SET_DEFAULT_MODEL =
  ...
  /** 9. 动态计算一键发送价格(火箭) */
  public static final String MG_CUSTOM_ROCKET_DYNAMIC_FIRE_PRICE =
  ...
  /** 12. 模型更换组件(火箭) */
  public static final String MG_CUSTOM_ROCKET_REPLACE_COMPONENT =
  ...
  /** 14. 播放效果开始(火箭) */
  public static final String MG_CUSTOM_ROCKET_PLAY_EFFECT_START =
  ...
  /** 15. 播放效果完成(火箭) */
  public static final String MG_CUSTOM_ROCKET_PLAY_EFFECT_FINISH =
  ...
  /** 17. 上传icon(火箭) */
  public static final String MG_CUSTOM_ROCKET_UPLOAD_MODEL_ICON =
  ...
  /** 18. 前期准备完成(火箭) 表示app此时可以向火箭发出指令了 */
  ...
  /** 21. 点击锁住组件(火箭) */
  public static final String MG_CUSTOM_ROCKET_CLICK_LOCK_COMPONENT =
  ...
  // region 棒球
  /** 1. 查询排行榜数据(棒球) 游戏客户端通知APP查询排行榜数据 */
  ...
  /** 3. 查询当前距离我的前后玩家数据(棒球) 游戏客户端通知APP查询当前距离我的前后玩家数据（需要排除自己） */
  ...
  /** 4. 设置app提供给游戏可点击区域(棒球) 游戏客户端通知APP指令动作设置点击区域 */
  ...
  /** 5. 前期准备完成(棒球) 游戏客户端通知APP指令动作前期准备完成 */
  ...
  /** 6. 主界面已显示(棒球) 游戏客户端通知APP指令动作主界面已显示 */
  ...
  /** 7. 主界面已隐藏(棒球) 游戏客户端通知APP指令动作主界面已隐藏 */

...
/** 游戏配置模型 参考文档：https://docs.sud.tech/zh-CN/app/Client/API/ISudFSMMG/onGetGameCfg.html */
public class GameConfigModel implements Serializable {
  ...
  public static class GameUi implements Serializable {
    ...
    public GameLobbyPlayerCaptainIcon lobby_player_captain_icon =
        new GameLobbyPlayerCaptainIcon(); // 大厅玩家展示位上队长标识
    public GameLobbyPlayerKickoutIcon lobby_player_kickout_icon =
        new GameLobbyPlayerKickoutIcon(); // 大厅玩家展示位上踢人标识
    ...
    public GameSettingSelectPnl game_setting_select_pnl =
        new GameSettingSelectPnl(); // 大厅中的玩法选择设置面板
    ...
    public GameCountdownTime game_countdown_time =
        new GameCountdownTime(); // 游戏中游戏倒计时显示 （注：现在只针对umo生效）
    public GameSelectedTips game_selected_tips =
        new GameSelectedTips(); // 游戏中所选择的玩法提示文字 （注：现在只针对ludo生效）
  ...
  public static class GamePing implements Serializable {
    public boolean hide = true; // 是否隐藏ping值（false: 显示；true: 隐藏，默认为false）
  }

  // 界面中的版本信息值
  public static class GameVersion implements Serializable {
    public boolean hide = true; // 是否隐藏版本信息（false: 显示； true: 隐藏，默认为false）
  }
  ...
  public static class GameLobbyPlayers implements Serializable {
    ...
    public boolean hide = true; // 是否隐藏大厅玩家展示位（false: 显示； true: 隐藏，默认为false）
  }

  // 大厅玩家展示位上队长标识
  public static class GameLobbyPlayerCaptainIcon implements Serializable {
    public boolean hide = true; // 是否隐藏大厅玩家展示位上队长标识（false: 显示； true: 隐藏，默认为false）
  }

  // 大厅玩家展示位上踢人标识
  public static class GameLobbyPlayerKickoutIcon implements Serializable {
    public boolean hide = true; // 是否隐藏大厅玩家展示位上踢人标识（false: 显示； true: 隐藏，默认为false）
  }
  ...
  public static class GameJoinBtn implements Serializable {
    ...
    public boolean hide = true; // 是否隐藏加入按钮（false: 显示； true: 隐藏，默认为false）
  }
  ...
  public static class GameCancelJoinBtn implements Serializable {
    ...
    public boolean hide = true; // 是否隐藏取消加入按钮（false: 显示； true: 隐藏，默认为false）
  }
  ...
  public static class GameReadyBtn implements Serializable {
    ...
    public boolean hide = true; // 是否隐藏准备按钮（false: 显示； true: 隐藏，默认为false）
  }
  ...
  public static class GameCancelReadyBtn implements Serializable {
    ...
    public boolean hide = true; // 是否隐藏取消准备按钮（false: 显示； true: 隐藏，默认为false）
  }
  ...
  public static class GameStartBtn implements Serializable {
    ...
    public boolean hide = true; // 是否隐藏开始游戏按钮（false: 显示； true: 隐藏，默认为false）
  }
  ...
  public static class GameSettleCloseBtn implements Serializable {
    public boolean custom =
        true; // 游戏结算界面中的关闭按钮（false: 关闭结算界面返回大厅； true: 游戏通知按钮点击事件，并关闭结算界面返回大厅；默认为false）
  }

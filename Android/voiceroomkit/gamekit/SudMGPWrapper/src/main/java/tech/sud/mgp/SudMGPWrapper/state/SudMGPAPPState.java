...
/** APP to MG 的通用状态定义 参考文档：https://docs.sud.tech/zh-CN/app/Client/APPFST/ */
public class SudMGPAPPState implements Serializable {

  // region 通用状态
  /** 1. 加入状态 最低版本: v1.1.30.xx */
  public static final String APP_COMMON_SELF_IN = "app_common_self_in";

  /**
   * 1. 加入状态 模型 用户（本人）加入游戏/退出游戏 正确流程： 1.isIn=true: 加入游戏=>准备游戏=>开始游戏; 2.isIn=false: 结束=>取消准备=>退出游戏;
   */
  ...
  /** 9. 麦克风状态 模型 用户（本人）麦克风状态，建议： 进入房间后初始通知一次； 每次变更（开麦/闭麦/禁麦/解麦）通知一次； */
  ...
  /**
   * 10. 文字命中状态 模型 用户（本人）聊天信息命中关键词状态，建议： 精确匹配； 首次聊天内容命中关键词之后，后续聊天内容不翻转成未命中； 直至小游戏侧关键词更新，再将状态翻转为未命中；
   */
  ...
  public static final String APP_COMMON_GAME_SETTING_SELECT_INFO =
  ...
  // region 元宇宙砂砂舞
  /** 1. 元宇宙砂砂舞相关设置 参考文档：https://docs.sud.tech/zh-CN/app/Client/APPFST/CommonStateForDisco.html */
  ...
  /** 5. 订单记录列表回调 */
  public static final String APP_CUSTOM_ROCKET_ORDER_RECORD_LIST =
  ...
  /** 6. 展馆内列表回调 */
  public static final String APP_CUSTOM_ROCKET_ROOM_RECORD_LIST =
  ...
  /** 7. 展馆内玩家送出记录回调 */
  public static final String APP_CUSTOM_ROCKET_USER_RECORD_LIST =
  ...
  /** 8. 设置默认模型(火箭) */
  public static final String APP_CUSTOM_ROCKET_SET_DEFAULT_MODEL =
  ...
  /** 9. 动态计算一键发送价格回调 */
  public static final String APP_CUSTOM_ROCKET_DYNAMIC_FIRE_PRICE =
  ...
  /** 12. 更换组件 回调 */
  public static final String APP_CUSTOM_ROCKET_REPLACE_COMPONENT =
  ...
  /** 14. app播放火箭发射动效(火箭) */
  public static final String APP_CUSTOM_ROCKET_PLAY_MODEL_LIST =
  ...
  /** 17. app主动调起火箭主界面(火箭) */
  public static final String APP_CUSTOM_ROCKET_SHOW_GAME_SCENE =
  ...
  /** 18. app主动隐藏火箭主界面(火箭) */
  public static final String APP_CUSTOM_ROCKET_HIDE_GAME_SCENE =
  ...
  /** 19. app推送解锁组件(火箭) */
  public static final String APP_CUSTOM_ROCKET_UNLOCK_COMPONENT =
  ...
  /** 21. app推送关闭火箭播放效果(火箭) */
  public static final String APP_CUSTOM_ROCKET_CLOSE_PLAY_EFFECT =

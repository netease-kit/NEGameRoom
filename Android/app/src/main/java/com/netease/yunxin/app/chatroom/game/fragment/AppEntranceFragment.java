...
import com.netease.yunxin.app.chatroom.game.databinding.FragmentAppEntranceBinding;
  ...
  private void initView() {
    ...
    list.add(
        new FunctionAdapter.FunctionItem(
            getString(R.string.app_game_room),
            getString(R.string.app_game_room_desc),
            R.drawable.home_item_bg_game_room,
            R.raw.home_game,
            () -> {
              GameNavUtils.toGameRoomListPage(getContext());
            }));

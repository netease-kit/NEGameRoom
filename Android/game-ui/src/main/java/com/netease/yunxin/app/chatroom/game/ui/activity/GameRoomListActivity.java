...
import com.netease.yunxin.app.chatroom.game.ui.adapter.GameRoomListAdapter;
...
public class GameRoomListActivity extends RoomListActivity {
  private static final String TAG_REPORT_PAGE_GAME_ROOM = "page_game_list";

  @Override
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    binding.tvTitle.setText(getString(R.string.game_room));
    binding.tvStart.setText(getString(R.string.create_room));
    ReportUtils.report(GameRoomListActivity.this, TAG_REPORT_PAGE_GAME_ROOM, "game_enter");
  }
  ...
  protected void setEvent() {
    ...
    binding.ivCreateRoom.setOnClickListener(
        v -> {
          ReportUtils.report(
              GameRoomListActivity.this, TAG_REPORT_PAGE_GAME_ROOM, "game_start_live");
          Intent intent = new Intent(this, GameRoomCreateActivity.class);
  ...
  protected RoomListAdapter getRoomListAdapter() {
    return new GameRoomListAdapter(GameRoomListActivity.this);
  }
        ...
        .getRoomList(
            ...
            new NEVoiceRoomCallback<NEVoiceRoomList>() {
              ...
              public void onFailure(int code, @Nullable String msg) {
                ...
                ToastUtils.INSTANCE.showShortToast(
                    GameRoomListActivity.this, getString(R.string.network_error));
              }
            });
  }
  ...
  private void handleJoinVoiceRoom(RoomModel info) {
    if (FloatPlayManager.getInstance().isShowFloatView()) {
      if (FloatPlayManager.getInstance().getVoiceRoomInfo() != null
        ...
        NavUtils.toGameAudiencePage(GameRoomListActivity.this, userName, avatar, info, false);
      } else {
        AlertDialog.Builder builder = new AlertDialog.Builder(GameRoomListActivity.this);
                  ...
                  .leaveRoom(
                      new NEVoiceRoomCallback<Unit>() {
                        ...
                        public void onSuccess(@Nullable Unit unit) {
                          NavUtils.toGameAudiencePage(
                              GameRoomListActivity.this, userName, avatar, info, true);
                        }
      ...
      NavUtils.toGameAudiencePage(GameRoomListActivity.this, userName, avatar, info, true);
    }
  }
}

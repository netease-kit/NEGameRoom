...
package com.netease.yunxin.app.chatroom.game.ui.dialog;
...
public class SelectGameDialog extends BaseBottomDialog {
  public static final String TAG = "SelectGameDialog";
  private GameAdapter gameAdapter;

  public SelectGameDialog(OnGameSelectListener listener) {
    gameAdapter = new GameAdapter();
    gameAdapter.setGameListener(listener);
  }
  ...
  protected View getRootView(
    ...
    View bottomView =
        LayoutInflater.from(getContext()).inflate(R.layout.dialog_game_select, viewGroup);
